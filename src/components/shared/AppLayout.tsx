...
export default function AppLayout({
  ...
  return (
    ...
    >
      ...
      <main className="app-main" style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>{children}</main>
...
function AppFooter() {
  return (
    ...
    >
      <div className="app-footer-inner" style={{ display: 'flex', alignItems: 'flex-start', gap: 80 }}>
        {/* Logo */}
        ...
        {/* Copyright */}
        <div className="app-footer-copyright" style={{ marginLeft: 'auto', flexShrink: 0, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'flex-end', alignSelf: 'stretch', fontSize: 13, gap: 4, whiteSpace: 'nowrap' }}>
